...
var handlers = map[string]func(ctx *common.ModuleContext, i *discordgo.InteractionCreate){
	...
	BUTTON_PARTICIPATE_BENCH: handleParticipateBench,
...
func handleParticipateBench(ctx *common.ModuleContext, i *discordgo.InteractionCreate) {
	handleParticipation(ctx, i, types.WarParticipationBench)
}
