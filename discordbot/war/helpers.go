...
// createWarEmbed creates the main war embed with participation counts
func createWarEmbed(war *types.War) *discordgo.MessageEmbed {
	...
	confirmedCount := yesCount + benchCount
	...
	embed := &discordgo.MessageEmbed{
		...
		Fields: []*discordgo.MessageEmbedField{
			...
			{
				Name: "Respostas",
				Value: fmt.Sprintf("%s **Sim:** %d\n%s **Não:** %d\n%s **Talvez:** %d\n%s **Banco:** %d",
					EMOJI_YES, yesCount,
					EMOJI_NO, noCount,
					EMOJI_MAYBE, maybeCount,
					EMOJI_BENCH, benchCount),
				Inline: false,
			},
		},
